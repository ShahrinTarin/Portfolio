  ...
  return (
    <>
      <motion.div
        ...
        className="w-11/12 mx-auto bg-gradient-to-br from-[#0f0f0f] to-black rounded-xl border border-neutral-800 p-6 md:flex gap-8 hover:border-green-500 transition"
      >
        {/* Left: Image */}
